...
var createFunkoPopTable = "CREATE TABLE IF NOT EXISTS funkopop (id TEXT UNIQUE, series TEXT, category TEXT, name TEXT, number INTEGER, image BLOB, value REAL, PRIMARY KEY(series, category, name, number), FOREIGN KEY(category) REFERENCES popcategory(id) FOREIGN KEY(series) REFERENCES popseries(id))";
